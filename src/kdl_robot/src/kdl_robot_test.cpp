...
int main(int argc, char **argv)
{
    ...
    robot_init_config.request.joint_positions.push_back(0.0);  //Configuration changed in order to visualize the aruco marker
    ...
    std::cout << "Choose desired controller:" << std::endl
              << "1. Joint Space I-D Controller\n" << "2. Operational Space I-D Controller\n";
